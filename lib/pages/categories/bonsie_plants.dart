...
import 'package:cart_ui/pages/item_list2.dart';
...
class Bonsie extends StatefulWidget {
  const Bonsie({ Key? key }) : super(key: key);

  @override
  State<Bonsie> createState() => _BonsieState();
}

class _BonsieState extends State<Bonsie> {
  late List<Product> products;
  final ItemList2 = BonsieList().data;
  ...
  void initState() {
    ...
    List item = ItemList2['products'] as List;
    setState(() {
