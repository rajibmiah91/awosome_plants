...
import 'package:cart_ui/pages/item_list3.dart';
...
class InHouseItems extends StatefulWidget {
  const InHouseItems({ Key? key }) : super(key: key);

  @override
  State<InHouseItems> createState() => _InHouseItemsState();
}

class _InHouseItemsState extends State<InHouseItems> {
  late List<Product> products;
  final itemList3 = InHouseList().data;
  ...
  void initState() {
    ...
    List item = itemList3['products'] as List;
    setState(() {
